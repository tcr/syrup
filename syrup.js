...
var DefaultContext = function() {
  ...
  host.eval = function (call) {
    return this["eval"].apply(this, call);
  };

  host.fn = macro(function() {
  ...
  host.quote = macro(function(arg) {
    return arg;
  });

  host['atom?'] = macro(function(arg) {
  ...
  host['instanceof'] = function(a, b) {
    return a instanceof b;
  };

  host['regex'] = function(str, flags) {
    return new RegExp(str, flags);
  };

  host['if'] = macro(function(test, t, f) {
    if (this["eval"](test)) {
      return this["eval"](t);
    } else {
      return this["eval"](f);
  ...
  host['throw'] = function (expr) {
    throw expr;
  };

  return new exports.Context(host);
};
